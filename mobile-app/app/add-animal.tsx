...
export default function AddAnimalScreen() {
  ...
  const handleRegister = async () => {
    if (!name.trim()) {
      Alert.alert(
        "Missing Information",
        "Please enter the animal's name or tag ID.",
      );
      return;
    }
    if (!selectedFarm) {
      Alert.alert(
        "No Farm Selected",
        "Please select or create a farm first.",
      );
      return;
    }
        ...
        >
          ...
          <View style={styles.formSection}>
            ...
            <View style={styles.inputGroup}>
              ...
              >
                <Text
                  style={[styles.inputText, !breed && styles.placeholderText]}
                >
                  {breed || "Select Breed"}
                </Text>
              ...
              <View style={styles.genderRow}>
                ...
                >
                  <Ionicons
                    name="male"
                    size={24}
                    color={gender === "Male" ? "#00E632" : "#8BA890"}
                  />
                  <Text
                    style={[
                      styles.genderText,
                ...
                >
                  <Ionicons
                    name="female"
                    size={24}
                    color={gender === "Female" ? "#00E632" : "#8BA890"}
                  />
                  <Text
                    style={[
                      styles.genderText,
            ...
            <View style={styles.modalSheet}>
              ...
              <FlatList
                ...
                ItemSeparatorComponent={() => (
                  <View style={styles.breedSeparator} />
                )}
              />
            </View>
          </TouchableWithoutFeedback>
